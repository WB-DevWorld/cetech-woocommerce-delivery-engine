...
} elseif ( is_readable( $bulk_js ) && ( str_contains( $header_source, '1.0.0-dev.bulk.9' ) || str_contains( $header_source, '1.0.0-dev.fulfilment' ) || str_contains( $header_source, '1.0.0-dev.blocks' ) || str_contains( $header_source, '1.0.0-dev.cartstate' ) || str_contains( $header_source, '1.0.0-dev.peritem' ) || str_contains( $header_source, '1.0.0-rc.7' ) || str_contains( $header_source, '1.0.0-rc.8' ) || str_contains( $header_source, '1.0.0-rc.9' ) ) ) {

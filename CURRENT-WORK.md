...
Status: RC.12 IMMUTABLE — POST-RC.12 DEV CANDIDATE `1.0.0-dev.geo-country.3` — AWAITING FINAL DIFFERENTIAL REVIEW / NOT RC.13 / NOT DEPLOYED / NOT MERGED
...
## Central leases
- plugin bootstrap / version identity on this branch: `1.0.0-dev.geo-country.3`; published `1.0.0-rc.12` remains the tagged identity;
...
- Training site `https://training.cetechbpa.com`: read-only forensics for Issue #35. Plugin currently `1.0.0-dev.geo-live.2`. Do not deploy geo-country.1, geo-country.2, or geo-country.3 until owner/ChatGPT review. Do not confirm migrated Accra/Kumasi coverage. Do not click I reviewed this migrated coverage / Confirm replacement. Do not rerun safe reconciliation. Do not reset the GH pack.
...
Do not create RC.13. Do not deploy this fix yet. Do not merge until differential review. Do not move `v1.0.0-rc.12` or overwrite its ZIP. Do not overwrite the frozen geo-country.1 or geo-country.2 ZIPs. Do not start CETECH Pilot. Do not deploy FLAIROC or production. Do not touch POS. Do not start Stage 15. Do not implement Issue #31 or Issue #32. Do not confirm Accra/Kumasi coverage. Do not fix the admin-notice overwrite (out of #35).

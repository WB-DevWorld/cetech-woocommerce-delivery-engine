...
- Development identity: `1.0.0-dev.geo.2`.
- Target schema: `6`.
...
- Implementation: technical-correction pass on `feat/canonical-geography-coverage`; not packaged as RC.11; not merged; not self-accepted.
...
## Central leases
- plugin bootstrap / version identity: `@wbdevworld` (issue #23 → `1.0.0-dev.geo.2`);

...
Status: RC.12 IMMUTABLE — POST-RC.12 DEV CANDIDATE `1.0.0-dev.geo-country.2` — AWAITING DIFFERENTIAL REVIEW / NOT RC.13 / NOT DEPLOYED / NOT MERGED
...
- Development identity: `1.0.0-dev.geo-country.2` (schema remains `6`).
- Runtime / package-source SHA: `23237eedece174b2f9c4334693b137310ce5c54a`.
- Frozen pre-deployment technical-review evidence: `1.0.0-dev.geo-country.1` / SHA `b61466ffc14c71e1a678eaf2d5b84f22bf6040cb` / ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.1.zip` (`1,794,741` bytes, SHA-256 `216e3a28d37e6af5f6cf97a69ef362dc946a94b1d26d8508c3d747d582198a6c`). Do not overwrite.
- PR: https://github.com/WB-DevWorld/cetech-woocommerce-delivery-engine/pull/36
- ZIP: `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.2.zip` (`1,798,020` bytes, SHA-256 `6e7f76e2d218a01e2af401cc646471dc2ce27afc8a52c6ad15e671df0b88122c`).
- Not RC.13. Not a release promotion. Do not merge or deploy until owner/ChatGPT differential review.

## Central leases
- plugin bootstrap / version identity on this branch: `1.0.0-dev.geo-country.2`; published `1.0.0-rc.12` remains the tagged identity;
...
- Training site `https://training.cetechbpa.com`: read-only forensics for Issue #35. Plugin currently `1.0.0-dev.geo-live.2`. Do not deploy geo-country.1 or geo-country.2 until owner/ChatGPT review. Do not confirm migrated Accra/Kumasi coverage. Do not click I reviewed this migrated coverage / Confirm replacement. Do not rerun safe reconciliation. Do not reset the GH pack.

...
Status: RC.12 IMMUTABLE — POST-RC.12 DEV CANDIDATE `1.0.0-dev.geo-country.4` — AWAITING DEPLOYMENT REVIEW / NOT RC.13 / NOT DEPLOYED / NOT MERGED
...
- Development identity: `1.0.0-dev.geo-country.4` (schema remains `6`).
- Runtime / package-source SHA: pending committed runtime SHA (this candidate).
...
- ZIP: `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.4.zip` (build after runtime CI SUCCESS; do not overwrite frozen .1/.2/.3).
- Not RC.13. Not a release promotion. Do not merge or deploy until owner/ChatGPT deployment review.

## Central leases
- plugin bootstrap / version identity on this branch: `1.0.0-dev.geo-country.4`; published `1.0.0-rc.12` remains the tagged identity;
...
- Training site `https://training.cetechbpa.com`: read-only forensics for Issue #35. Plugin currently `1.0.0-dev.geo-live.2`. Do not deploy geo-country.1, geo-country.2, geo-country.3, or geo-country.4 until owner/ChatGPT review. Do not confirm migrated Accra/Kumasi coverage. Do not click I reviewed this migrated coverage / Confirm replacement. Do not rerun safe reconciliation. Do not reset the GH pack.
...
Do not create RC.13. Do not deploy this fix yet. Do not merge until deployment review. Do not move `v1.0.0-rc.12` or overwrite its ZIP. Do not overwrite the frozen geo-country.1, geo-country.2, or geo-country.3 ZIPs. Do not start CETECH Pilot. Do not deploy FLAIROC or production. Do not touch POS. Do not start Stage 15. Do not implement Issue #31 or Issue #32. Do not confirm Accra/Kumasi coverage. Do not fix the admin-notice overwrite (out of #35).

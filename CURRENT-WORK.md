...
- Development identity: `1.0.0-dev.geo.5`.
- Target schema: `6`.
...
- Implementation: technical-correction pass for PR #24 comment `5719203208` / issue #23 geo.5 findings; not physically QA'd; not packaged as RC.11; not merged; not self-accepted.
...
## Central leases
- plugin bootstrap / version identity: `@wbdevworld` (issue #23 → `1.0.0-dev.geo.5`);

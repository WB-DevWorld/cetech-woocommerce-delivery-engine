...
Status: RC.12 IMMUTABLE — POST-RC.12 DEV CANDIDATE `1.0.0-dev.geo-live.1` — AWAITING TECHNICAL REVIEW / NOT RC.13 / NOT DEPLOYED
...
- Owner: `@wbdevworld` (explicit ChatGPT authorization; investigate and fix Issue #33 only).
- Branch: `fix/geography-pack-liveness` from protected `master` `83effbf081e54b47ef088673c8ac18217ab9dfda`.
- Development identity: `1.0.0-dev.geo-live.1` (schema remains `6`).
...
- ZIP: `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-live.1.zip` (`1,783,293` bytes, SHA-256 `6281f1b3f7d080ac9bb528fc1a117be909ac1ae05c052d6fe704cc053192ccbf`).
- Not RC.13. Not a release promotion. Do not deploy until owner/ChatGPT review.

## Central leases
- plugin bootstrap / version identity on this branch: `1.0.0-dev.geo-live.1`; published `1.0.0-rc.12` remains the tagged identity;
...
- Training site `https://training.cetechbpa.com`: read-only forensics for Issue #33. Do not click Continue / retry again. Do not run safe reconciliation. Do not edit geography DB rows. Do not deploy this candidate until local tests, PR/CI, and owner/ChatGPT review.

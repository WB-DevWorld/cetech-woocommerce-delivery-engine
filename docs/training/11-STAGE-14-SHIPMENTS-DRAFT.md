...
**Status:** Draft for `1.0.0-rc.5-qa.3` owner retest. Do **not** treat this as the published RC.4 training set. Screenshots and final wording wait for owner QA PASS.

...
The committed suite covers unit behavior, limited integration harnesses, JavaScript, Playwright admin fixtures, migration inspection, Blocks/Store API, package verification, PHP 8.1 CI, and historical physical owner QA. geo.11 adds real-MariaDB and Ghana pack evidence.

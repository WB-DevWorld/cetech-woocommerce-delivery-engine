...
| Stage 6B-2L final admin language | Presentation-only cleanup of Legacy Delivery Rules diagnostic wording + remaining primary-UI jargon; new ZIP `cetech-woocommerce-delivery-engine-stage6b-final.zip` (checksum recorded after package build). **Do not reuse** `…-stage6b-repaired.zip`. |

...
**This working tree (`fix/post-rc6-admin-setup-defects`):** Post-RC.6 Repair R1 QA **`1.0.0-rc.6-r1-qa.1` OWNER PHYSICAL FAIL** on training.cetechbpa.com. ZIP immutable. Follow-up repair (not QA.2 packaged) in `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1-FAILURE-REPAIR.md`. Schema remains `4`. **Not RC.7. Not a replacement for tagged `1.0.0-rc.6`.** In Store dual-choice, International ECR, Bulk Tools, FLAIROC, and tag `v1.0.0-rc.6` are untouched.  
...
| Post-RC.6 Repair R1 (this branch) | **QA.1 OWNER PHYSICAL FAIL** — identity `1.0.0-rc.6-r1-qa.1` ZIP immutable. Follow-up repair not yet packaged as QA.2. Artifact `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1-FAILURE-REPAIR.md`. Schema still `4`. No RC.7. |
...
| `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1-FAILURE-REPAIR.md` | QA.1 physical failure investigation + repair (QA.2 not packaged) |

...
**Staff training:** `docs/training/` updated for RC.8 operational features plus Cart/Checkout Blocks, overlapping Delivery Area pricing, and constrained vs global fallback (`1.0.0-dev.blocks.4`). Coverage matrix: `docs/training/13-FEATURE-COVERAGE-AND-CONFIRMATION.md`. Videos remain deferred; trainers tick live Pass/Fail/N/A. Not RC.9. FLAIROC not modified.  
**Plugin version:** development identity **`1.0.0-dev.blocks.4`** on `feat/post-rc8-integrations` (starts from tagged `v1.0.0-rc.8`). Tagged/protected published baseline remains **`1.0.0-rc.8`** (schema `5`, tag `v1.0.0-rc.8`). Constrained Delivery Area fallback after blocks.3 matched-area pricing. Do not retag RC.2–RC.8. Do not rebuild the RC.6, RC.7, or RC.8 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**Post-RC.8 Settings honesty + Cart/Checkout Blocks:** **BLOCKS.4 REPAIR** — identity `1.0.0-dev.blocks.4`, schema **`5`**. A Fallback area with location rules stays inside those rules; only a ruleless fallback is Everywhere else. Artifact `docs/POST-RC8-BLOCKS-4-CONSTRAINED-FALLBACK.md`. Blocks.3 matched-area pricing remains accepted. Classic unchanged. FLAIROC not modified. RC.8 tag untouched.  
...
**Schema target:** tagged RC.8 = `5`. Tagged RC.7 = `5`. Tagged RC.6 = `4`.  
**Git:** `feat/post-rc8-integrations` (starts from tagged `v1.0.0-rc.8`). Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, and RC.8 tag `v1.0.0-rc.8` **untouched**.  
...
| Post-RC.8 Settings honesty + Blocks | **BLOCKS.4 REPAIR** — `1.0.0-dev.blocks.4`, schema `5`. Constrained fallback cannot escape its geography; only a ruleless fallback is Everywhere else. Artifact `docs/POST-RC8-BLOCKS-4-CONSTRAINED-FALLBACK.md`. Blocks.3 Accra → Greater Accra pricing inheritance remains. Not Stage 15. FLAIROC not modified. |
| Next stage | **STOP.** Repair identity `1.0.0-dev.blocks.4`. Owner QA: Test an address country selector; Greater Accra Fallback must not match USA; a ruleless fallback may catch unmatched addresses; unmatched with no fallback stays fail closed. Do **not** create RC.9. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.8`. |
...
| `docs/POST-RC8-BLOCKS-4-QA.md` | `1.0.0-dev.blocks.4` owner-QA package record |

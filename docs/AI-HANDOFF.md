...
**Post-RC.11 issue #23:** active technical-correction candidate **`1.0.0-dev.geo.6`** on `feat/canonical-geography-coverage` / draft PR `#24`. Schema target **`6`**. Frozen rejected candidates: geo.1 / geo.2 / geo.3 / geo.4 / geo.5. Not merged. Not RC.12. Do not physically QA until independent review.  

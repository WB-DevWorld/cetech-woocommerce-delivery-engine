...
**Post-RC.7 fulfilment correctness:** **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.1` on `feat/post-rc7-fulfilment-correctness`. In Store Delivery + Store Pickup concurrent choices; International single-offer auto-select; DE-managed packages fail closed instead of native WC fallback. Schema **`5`**. ZIP record: `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Not RC.8. Not Stage 15. FLAIROC not modified.  
...
| Post-RC.7 fulfilment correctness | **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.1` on `feat/post-rc7-fulfilment-correctness`. Source `f7dd170c8ecb1009ca95c4c9e456b6c68cd11183`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.fulfilment.1.zip` (`1284412` bytes, SHA-256 `1fa195b59a3503c0e1362cc2c24f70f557ec98e8d27bb992a3c432d7ec128886`). Artifact `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Schema **`5`**. RC.7 tag/FLAIROC untouched. Owner physical QA: three scenarios only. |
| Next stage | **STOP.** QA ZIP is on the Desktop. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Do **not** create RC.8. Owner physical QA remains the three authorised scenarios only. |
...
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-IMPLEMENTATION.md` | Post-RC.7 fulfilment correctness implementation record (`1.0.0-dev.fulfilment.1`) |
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md` | `1.0.0-dev.fulfilment.1` owner-QA package record — packaged, not deployed |

...
| Package | Final `cetech-woocommerce-delivery-engine-1.0.0-rc.7.zip` (`1262689` bytes, SHA-256 `1881c0d89e288a14436e14a26f1ae359504a06cf2a77ef32b07f48e32797dbff`, source `ad3feeb`, tag `v1.0.0-rc.7`). Historical `cetech-woocommerce-delivery-engine-1.0.0-rc.6.zip` (`1059918` bytes, SHA-256 `0d4adbef50462d798a4ff9bf802643bed92a35cdd332ceee13a985dbda2a689d`, source `7e52525`, tag `v1.0.0-rc.6`) remains immutable. Historical `1.0.0-dev.bulk.7`–`1.0.0-dev.bulk.9` ZIPs remain immutable. |

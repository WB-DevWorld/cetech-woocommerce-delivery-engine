...
**Plugin version:** `1.0.0-dev.fulfilment.2` on `feat/post-rc7-fulfilment-correctness` (post-RC.7 fulfilment correctness, starting from tagged RC.7 source `ad3feebfd1aa92d078caaa557c0c0d11c090a0c6`). Tagged/protected published baseline remains **`1.0.0-rc.7`** (schema `5`, tag `v1.0.0-rc.7`). Historical tagged **`1.0.0-rc.6`** (schema `4`) remains untouched. Do not retag RC.2–RC.7. Do not rebuild the RC.6 or RC.7 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.7 fulfilment correctness:** **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.2` on `feat/post-rc7-fulfilment-correctness`. Scenario 1 admin repair on top of fulfilment.1 runtime: In Store available methods vs default customer choice, ECR Pickup Location, Pickup Locations R1, existing readiness column. Schema **`5`**. ZIP record: `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Repair note: `docs/POST-RC7-FULFILMENT-CORRECTNESS-ADMIN-REPAIR.md`. Not RC.8. Not Stage 15. FLAIROC not modified. Owner QA resumes with Scenario 1 only.  
...
| Post-RC.7 fulfilment correctness | **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.2` on `feat/post-rc7-fulfilment-correctness`. Source `48fc2d22464c76256cdbc85c47bc8e2f368a8582`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.fulfilment.2.zip` (`1297020` bytes, SHA-256 `a946723ca94588155681660285fda1778ac16fac987c8f317a080395e84383ec`). Artifacts `docs/POST-RC7-FULFILMENT-CORRECTNESS-ADMIN-REPAIR.md` and `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Schema **`5`**. RC.7 tag/FLAIROC untouched. Owner physical QA: **Scenario 1 only** until it passes. |
| Next stage | **STOP.** Replacement QA ZIP is on the Desktop. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Do **not** create RC.8. Owner resumes with Scenario 1 only. Continue to International / In Warehouse only after Scenario 1 passes. |
...
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md` | `1.0.0-dev.fulfilment.2` owner-QA package record — packaged, not deployed |

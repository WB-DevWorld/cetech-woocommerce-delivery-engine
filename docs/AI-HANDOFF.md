...
**Plugin version:** `1.0.0-dev.fulfilment.1` on `feat/post-rc7-fulfilment-correctness` (post-RC.7 fulfilment correctness, starting from tagged RC.7 source `ad3feebfd1aa92d078caaa557c0c0d11c090a0c6`). Tagged/protected published baseline remains **`1.0.0-rc.7`** (schema `5`, tag `v1.0.0-rc.7`). Historical tagged **`1.0.0-rc.6`** (schema `4`) remains untouched. Do not retag RC.2–RC.7. Do not rebuild the RC.6 or RC.7 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.7 fulfilment correctness:** In Store Delivery + Store Pickup as concurrent customer choices, International single-offer auto-select, fail-closed native-rate filter on DE-managed packages. Artifact: `docs/POST-RC7-FULFILMENT-CORRECTNESS-IMPLEMENTATION.md`. Audit: `docs/POST-RC7-FULFILMENT-CORRECTNESS-AUDIT.md`. Schema remains **`5`**. Not a package. Not Stage 15.  
...
| Post-RC.7 fulfilment correctness | **IMPLEMENTED / NOT PACKAGED** — `1.0.0-dev.fulfilment.1` on `feat/post-rc7-fulfilment-correctness`. In Store Delivery + Store Pickup concurrent choices; International single-offer auto-select; DE-managed packages fail closed instead of native WC fallback. Schema **`5`**. Artifact `docs/POST-RC7-FULFILMENT-CORRECTNESS-IMPLEMENTATION.md`. RC.7 tag/FLAIROC untouched. |
| Next stage | **STOP.** Implementation + green tests are complete. Do **not** package until the owner authorises packaging. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Historical `1.0.0-dev.bulk.7`–`1.0.0-dev.bulk.9` remain immutable. Do **not** repair the known non-blocking Catalog preview Ready-to-apply presentation issue in this stream. Owner physical QA remains the three authorised scenarios only, after packaging. |
...
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-IMPLEMENTATION.md` | Post-RC.7 fulfilment correctness implementation record (`1.0.0-dev.fulfilment.1`; not packaged) |

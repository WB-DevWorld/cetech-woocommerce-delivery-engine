...
**Plugin version:** `1.0.0-rc.8` on `feat/post-rc7-fulfilment-correctness` (promoted from owner-accepted `1.0.0-dev.fulfilment.4`, starting from tagged RC.7 source `ad3feebfd1aa92d078caaa557c0c0d11c090a0c6`). Tagged/protected published baseline is **`1.0.0-rc.8`** (schema `5`, tag `v1.0.0-rc.8`). Historical tagged **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched. Do not retag RC.2–RC.8. Do not rebuild the RC.6, RC.7, or RC.8 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
...
**Git:** `feat/post-rc7-fulfilment-correctness` (starts from tagged `v1.0.0-rc.7` / `ad3feeb`; promoted to `v1.0.0-rc.8`). Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6` and RC.7 tag `v1.0.0-rc.7` **untouched**.  
...
| Post-RC.7 fulfilment correctness | **PROMOTED TO TAGGED `1.0.0-rc.8`** — owner physical QA of `1.0.0-dev.fulfilment.4` on training.cetechbpa.com: **ALL THREE SCENARIOS PASSED**. Package source `6d166227998d4b0f5047fea91944ff024b389810`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-rc.8.zip` (`1307532` bytes, SHA-256 `70ae635e71741663d5084e3cccd0d2246871d7c485efb919310267d7c9d46b03`). Canonical record: `docs/RC8-FINALIZATION.md`. Schema **`5`**. RC.7 tag/FLAIROC untouched. Owner RC.8 confirmation: install, Active, version `1.0.0-rc.8`, schema `5`, one PDP + one admin page. Do not repeat the three scenarios. |
| Next stage | **STOP.** RC.8 ZIP is on the Desktop. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, `v1.0.0-rc.7`, or `v1.0.0-rc.8`. Owner RC.8 confirmation is install/Active/version/schema plus one PDP and one admin page only. |

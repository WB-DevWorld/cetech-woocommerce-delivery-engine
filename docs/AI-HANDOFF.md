...
**Post-RC.12 issue #35:** OPEN — GeoNames PCL* records can overwrite canonical country identity. Current candidate identity **`1.0.0-dev.geo-country.2`** on `fix/geonames-country-identity` from protected `master` `5abfab0b5078e67b158f282088022b2ac2566f22`. Runtime/package-source SHA `23237eedece174b2f9c4334693b137310ce5c54a`. Frozen geo-country.1 runtime `b61466ffc14c71e1a678eaf2d5b84f22bf6040cb` / ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.1.zip` (`1,794,741` bytes, SHA-256 `216e3a28d37e6af5f6cf97a69ef362dc946a94b1d26d8508c3d747d582198a6c`) must not be overwritten. PR `#36`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.2.zip` (`1,798,020` bytes, SHA-256 `6e7f76e2d218a01e2af401cc646471dc2ce27afc8a52c6ad15e671df0b88122c`). **Not RC.13. Not deployed.** Artifact `docs/POST-RC12-GEONAMES-COUNTRY-IDENTITY.md`. RC.12 tag/ZIP remain immutable.  
...
| `docs/POST-RC12-GEONAMES-COUNTRY-IDENTITY.md` | Issue #35 GeoNames canonical country identity candidate (`1.0.0-dev.geo-country.2`; frozen geo-country.1 evidence; not RC.13) |

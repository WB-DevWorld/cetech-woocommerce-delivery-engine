...
**This working tree (`fix/post-rc6-admin-setup-defects`):** Post-RC.6 Repair R1 QA identity **`1.0.0-rc.6-r1-qa.2`** for training.cetechbpa.com. QA.1 (`1.0.0-rc.6-r1-qa.1`) remains an **immutable OWNER PHYSICAL FAIL** artifact. Schema remains `4`. **Not RC.7. Not a replacement for tagged `1.0.0-rc.6`.** In Store dual-choice, International ECR, Bulk Tools, FLAIROC, and tag `v1.0.0-rc.6` are untouched.  
...
| Post-RC.6 Repair R1 (this branch) | **QA.2 PREPARED** — identity `1.0.0-rc.6-r1-qa.2`. QA.1 ZIP immutable OWNER PHYSICAL FAIL. Artifact `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1-FAILURE-REPAIR.md`. Schema still `4`. No RC.7. |

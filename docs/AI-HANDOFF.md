...
**Plugin version:** development tree **`1.0.0-dev.integrated.2`** on `feat/post-rc9-customer-ux` (schema `5`). Customer storefront presentation cleanup from qualified `1.0.0-dev.integrated.1` source `ac2bc94056ebc73f1c6f8ab4a0434f4e68ce7300`. Tagged/protected published baseline remains **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`). Do not retag RC.2–RC.9. Do not rebuild the RC.9 ZIP or the `1.0.0-dev.integrated.1` ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
...
**Git:** `feat/post-rc9-customer-ux` (customer presentation cleanup from qualified integrated.1 `ac2bc94`). Combined per-item + WCFM isolation remains the runtime base. WPML not merged. Historical `feat/post-rc9-integrated-candidate` preserved. Historical `feat/post-rc8-integrations` promoted to `v1.0.0-rc.9`. Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, RC.8 tag `v1.0.0-rc.8`, and RC.9 tag `v1.0.0-rc.9` **untouched**.
...
| Post-RC.9 customer UX | **OWNER VISUAL ACCEPTANCE APPROVED — `1.0.0-dev.integrated.2`** on `feat/post-rc9-customer-ux` from `ac2bc94`. Presentation only. Schema **`5`**. Not RC.10. Screenshots: `cetech-de-local-qa/evidence/integrated.2/`. Artifact: `docs/POST-RC9-CUSTOMER-UX.md`. |
| Next stage | **STOP.** Tagged `1.0.0-rc.9` remains the protected published baseline. Training in-place install was **not** completed from Cursor (no training SSH/WP-CLI/browser admin path). This qualification assembly now includes post-RC.9 cart-state reconciliation, Blocks line snapshots, per-item destinations, WCFM isolation, and integrated.2 customer storefront cleanup as implemented-but-unreleased candidate history. WPML is not included. It is not RC.10. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.9` or earlier. After a human in-place training install, confirm Active / `1.0.0-rc.9` / schema `5` / cart `12` / checkout `13` / layouts 1482·1496·1500 publish. Cursor must **not** install qualification packages. |

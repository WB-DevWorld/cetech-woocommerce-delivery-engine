...
**Plugin version:** tagged/protected published baseline **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`) on `feat/post-rc8-integrations`, promoted from frozen `1.0.0-dev.blocks.4` packaged source `796b9a52add1053520b2e440d60aa88814d6dd0c`. Historical tagged **`1.0.0-rc.8`** (schema `5`) remains untouched. Do not retag RC.2–RC.9. Do not rebuild the RC.6, RC.7, RC.8, or RC.9 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**This worktree (post-RC.9 WPML):** development identity **`1.0.0-dev.wpml.1`** on `feat/post-rc9-wpml`, rooted from immutable `v1.0.0-rc.9`. Schema remains **`5`**. Presentation-only WPML String Translation for administrator-entered public copy. One Delivery Engine entity per offer/location/area; WPML supplies language text. Packaged source `e85b44d256852666a9c46b673c7903c0f56388ce`. ZIP SHA-256 `98d29a132b008e3ef7f382c0f80368b196ac4bcf0f9d9f1c1ee5e283de344444`. Does not merge cart-state or WCFM streams. Does not retag or rebuild RC.9. FLAIROC not modified. Not Stage 15. Canonical record: `docs/POST-RC9-WPML-DYNAMIC-STRINGS.md`. Physical QA plan: `docs/POST-RC9-WPML-QA.md`. **DO NOT DEPLOY from Cursor.**  
...
**Schema target:** tagged RC.9 = `5`. Tagged RC.8 = `5`. Tagged RC.7 = `5`. Tagged RC.6 = `4`.  
**Git:** this worktree `feat/post-rc9-wpml` (rooted from immutable `v1.0.0-rc.9`). Protected RC.9 branch remains `feat/post-rc8-integrations`. Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, RC.8 tag `v1.0.0-rc.8`, and RC.9 tag `v1.0.0-rc.9` **untouched**.  
...
| Next stage | **STOP.** RC.9 ZIP is on the Desktop. Install in place on training.cetechbpa.com only. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.8` or earlier. Beta testers vet Classic storefront usage. Do not manufacture another large owner-QA cycle. |

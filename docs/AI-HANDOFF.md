...
**Post-RC.12 issue #29:** OPEN — checkout “Use my checkout address” flattened a GH + Accra cart on training. Candidate identity **`1.0.0-dev.checkout-mdest.1`** on `fix/checkout-multi-destination-preservation`. **Not RC.13. Not deployed.** Artifact `docs/POST-RC12-CHECKOUT-MULTIDEST.md`. RC.12 tag/ZIP remain immutable.  

...
**Plugin version:** development tree **`1.0.0-dev.wcfm.1`** on `feat/post-rc9-wcfm-isolation` (schema `5`), rooted from tagged **`1.0.0-rc.9`**. Tagged/protected published baseline remains **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`). Do not retag RC.2–RC.9. Do not rebuild the RC.9 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**Post-RC.9 WCFM administrative isolation:** **IN THIS TREE** — WCFM vendors are kept outside Delivery Engine administration; vendor fulfilment controls are not provided. Canonical record: `docs/POST-RC9-WCFM-ISOLATION.md`. Schema remains **`5`**. Capability matrix version **`4`**. Not RC.10. Not Stage 15. FLAIROC not modified. RC.9 tag untouched.  
...
**Git:** `feat/post-rc9-wcfm-isolation` (post-RC.9 WCFM administrative isolation, rooted from `v1.0.0-rc.9`). Historical `feat/post-rc8-integrations` promoted to `v1.0.0-rc.9`. Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, RC.8 tag `v1.0.0-rc.8`, and RC.9 tag `v1.0.0-rc.9` **untouched**.  
...
| Next stage | **STOP for owner physical QA of untagged `1.0.0-dev.wcfm.1`.** Tagged `1.0.0-rc.9` remains the protected published baseline. Development identity is `1.0.0-dev.wcfm.1` / schema `5`. Qualification: `docs/POST-RC9-WCFM-ISOLATION-QA.md`. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.9` or earlier. Cursor must **not** install the owner-QA package. |

...
**Post-RC.9 per-item customer context:** **IN THIS TREE as `1.0.0-dev.peritem.1`** — Stages 1–2 domain + cart-state foundation only. Automated tests + local Docker QA A–G **PASS**. No storefront UI. Schema remains **`5`**. Not RC.10. Not Stage 15. FLAIROC / training / WCFM / WPML untouched. RC.9 tag untouched. Canonical record: `docs/POST-RC9-PER-ITEM-CONTEXT.md`.  
...
| `docs/POST-RC9-PER-ITEM-CONTEXT.md` | Post-RC.9 per-item customer context Stages 1–2 foundation (`1.0.0-dev.peritem.1`) |

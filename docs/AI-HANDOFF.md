...
**Post-RC.12 issue #33:** OPEN — Ghana Location Pack can remain `importing` with no continuation scheduled. Current candidate identity **`1.0.0-dev.geo-live.2`** on `fix/geography-pack-liveness` from protected `master` `83effbf081e54b47ef088673c8ac18217ab9dfda`. Runtime/package-source SHA `cd5cdfbbebfa243feb5f0bf66121edee55b16e87`. PR `#34`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-live.2.zip` (`1,786,463` bytes, SHA-256 `c5ea75fd407aa32a9e443a3f883e3036785cc776dcf715a040026087fdf8c149`). Frozen geo-live.1 ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-live.1.zip` (`1,783,293` bytes, SHA-256 `6281f1b3f7d080ac9bb528fc1a117be909ac1ae05c052d6fe704cc053192ccbf`) must not be overwritten. Training still runs `1.0.0-dev.checkout-mdest.1`; geo-live has **not** been deployed. **Not RC.13. Not merged. Not deployed.** Artifact `docs/POST-RC12-GEO-LIVENESS.md`. RC.12 tag/ZIP remain immutable.  

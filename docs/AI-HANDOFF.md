...
**Plugin version:** `1.0.0-dev.fulfilment.3` on `feat/post-rc7-fulfilment-correctness` (post-RC.7 fulfilment correctness, starting from tagged RC.7 source `ad3feebfd1aa92d078caaa557c0c0d11c090a0c6`). Tagged/protected published baseline remains **`1.0.0-rc.7`** (schema `5`, tag `v1.0.0-rc.7`). Historical tagged **`1.0.0-rc.6`** (schema `4`) remains untouched. Do not retag RC.2–RC.7. Do not rebuild the RC.6 or RC.7 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.7 fulfilment correctness:** **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.3` on `feat/post-rc7-fulfilment-correctness`. Scenario 1 cart presentation repair on top of accepted fulfilment.2 architecture: human-readable Pickup Location address (never JSON) and Store Pickup groups labelled as pickup at the store, not shipping to the customer address. Schema **`5`**. ZIP record: `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Repair note: `docs/POST-RC7-FULFILMENT-CORRECTNESS-CART-PRESENTATION.md`. Not RC.8. Not Stage 15. FLAIROC not modified. Owner QA: Scenario 1 cart recheck only (Pickup-only cart + mixed Delivery + Pickup cart).  
...
**Schema target:** tagged RC.7 = `5`. Tagged RC.6 = `4`.  
**Git:** `feat/post-rc7-fulfilment-correctness` (starts from tagged `v1.0.0-rc.7` / `ad3feeb`). Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6` and RC.7 tag `v1.0.0-rc.7` **untouched**.  
...
| Post-RC.6 RC.7 finalization | Tagged **`1.0.0-rc.7`** remains the protected published baseline — version `1.0.0-rc.7`; schema `5`; artifact `docs/RC7-FINALIZATION.md`. Owner-accepted from `1.0.0-dev.bulk.9` on training.cetechbpa.com. FLAIROC not modified. RC.6 tag untouched. |
| Post-RC.7 fulfilment correctness | **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.3` on `feat/post-rc7-fulfilment-correctness`. Source `6a2091c28b7d32bae5e857dfb4ef4032dae5922b`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.fulfilment.3.zip` (`1303042` bytes, SHA-256 `6b9337bd9a8f5ffb57dde8fa4ea8bb5e7406280df52609fdb49c4845d0f30285`). Artifacts `docs/POST-RC7-FULFILMENT-CORRECTNESS-CART-PRESENTATION.md` and `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Schema **`5`**. RC.7 tag/FLAIROC untouched. Owner physical QA: **Scenario 1 cart recheck only** (Pickup-only + mixed Delivery + Pickup). |
| Next stage | **STOP.** Replacement QA ZIP is on the Desktop. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Do **not** create RC.8. Owner rechecks one Pickup-only cart and one mixed Delivery + Pickup cart. Continue to International / In Warehouse only after Scenario 1 passes. |
...
| Package | Final `cetech-woocommerce-delivery-engine-1.0.0-rc.7.zip` details in `docs/RC7-FINALIZATION.md` after packaging. Historical `cetech-woocommerce-delivery-engine-1.0.0-rc.6.zip` (`1059918` bytes, SHA-256 `0d4adbef50462d798a4ff9bf802643bed92a35cdd332ceee13a985dbda2a689d`, source `7e52525`, tag `v1.0.0-rc.6`) remains immutable. Immutable `1.0.0-rc.6-qa.2.zip` / `1.0.0-rc.6-qa.1.zip` and protected historical `cetech-woocommerce-delivery-engine-1.0.0-rc.5.zip` remain unchanged. Historical `1.0.0-dev.bulk.7`–`1.0.0-dev.bulk.9` ZIPs remain immutable. |
...
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-CART-PRESENTATION.md` | Scenario 1 cart presentation repair (`1.0.0-dev.fulfilment.3`) |
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md` | `1.0.0-dev.fulfilment.3` owner-QA package record — packaged, not deployed |

...
**Plugin version:** `1.0.0-dev.bulk.3` on `feat/post-rc6-bulk-tools` (post-RC.6 Bulk Tools development). Tagged/protected published baseline remains **`1.0.0-rc.6`** (schema `4`). Do not retag RC.2–RC.6. Do not rebuild the RC.6 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.6 Bulk Tools:** authorised separately from Stage 14/15. Schema target in **this tree** is **`5`**. Architecture: `docs/POST-RC6-BULK-TOOLS-ARCHITECTURE.md`. Implementation: `docs/POST-RC6-BULK-TOOLS-IMPLEMENTATION.md`. Qualification: `docs/POST-RC6-BULK-TOOLS-QUALIFICATION.md`. Previous untagged owner-QA package **`1.0.0-dev.bulk.2`** remains immutable (`cetech-woocommerce-delivery-engine-1.0.0-dev.bulk.2.zip`, `1159232` bytes, SHA-256 `a3150ebaa799c5af151f0c2a981e36905b6830e0f08ec468cca66a88fb7d5e2f`, source `8c0d872fa41d16f6a3eaccdbd2b87a0fcfa2ba53`, schema `5`). Current untagged owner-QA package **`1.0.0-dev.bulk.3`** (`cetech-woocommerce-delivery-engine-1.0.0-dev.bulk.3.zip`, `1167830` bytes, SHA-256 `5aa19ffb201452dc463b01b015653365d0e78aabe8b0d53baa082777549d8da6`, source `a250b045c5783d0f4761fce99cda7b21f87e4337`, schema `5`). Cursor must not install it on training.cetechbpa.com, FLAIROC, or another owner site.  
...
| Next stage | **STOP for owner physical retest of untagged `1.0.0-dev.bulk.3`** (Catalog admin UX repair). Tagged `1.0.0-rc.6` remains the protected published baseline. Development identity is `1.0.0-dev.bulk.3` / schema `5`. Qualification: `docs/POST-RC6-BULK-TOOLS-QUALIFICATION.md`. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5` or `v1.0.0-rc.6`. Cursor must **not** install the owner-QA package. Previous `1.0.0-dev.bulk.2` ZIP is immutable. |

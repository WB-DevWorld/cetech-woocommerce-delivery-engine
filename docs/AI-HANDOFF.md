...
**Plugin version:** `1.0.0-dev.fulfilment.4` on `feat/post-rc7-fulfilment-correctness` (post-RC.7 fulfilment correctness, starting from tagged RC.7 source `ad3feebfd1aa92d078caaa557c0c0d11c090a0c6`). Tagged/protected published baseline remains **`1.0.0-rc.7`** (schema `5`, tag `v1.0.0-rc.7`). Historical tagged **`1.0.0-rc.6`** (schema `4`) remains untouched. Do not retag RC.2–RC.7. Do not rebuild the RC.6 or RC.7 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.7 fulfilment correctness:** **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.4` on `feat/post-rc7-fulfilment-correctness`. Mixed-cart repair: Store Pickup packages do not render WooCommerce `Shipping to` / `Change address`; Delivery packages keep that copy. Schema **`5`**. ZIP record: `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Repair note: `docs/POST-RC7-FULFILMENT-CORRECTNESS-CART-PRESENTATION.md`. Not RC.8. Not Stage 15. FLAIROC not modified. Owner QA: **one mixed Delivery + Pickup cart screenshot only**.  
...
| Post-RC.7 fulfilment correctness | **PACKAGED / NOT DEPLOYED** — `1.0.0-dev.fulfilment.4` on `feat/post-rc7-fulfilment-correctness`. Source `844544ad4020e2c17616145de31a6d6b67bb5128`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.fulfilment.4.zip` (`1303884` bytes, SHA-256 `f31401636a7c3cadf68636bbdc9a94224782eb3fbf408696880da9d11ac67127`). Artifacts `docs/POST-RC7-FULFILMENT-CORRECTNESS-CART-PRESENTATION.md` and `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md`. Schema **`5`**. RC.7 tag/FLAIROC untouched. Owner physical QA: **one mixed Delivery + Pickup cart screenshot only**. |
| Next stage | **STOP.** Replacement QA ZIP is on the Desktop. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Do **not** create RC.8. Owner rechecks **one mixed Delivery + Pickup cart**. Continue to International / In Warehouse only after Scenario 1 passes. |
...
| `docs/POST-RC7-FULFILMENT-CORRECTNESS-QA.md` | `1.0.0-dev.fulfilment.4` owner-QA package record — packaged, not deployed |

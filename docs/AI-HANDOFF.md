...
| Next stage | **STOP** after Bulk.9 implementation + tests. Artifact `docs/POST-RC6-BULK8-PHYSICAL-QA-REPAIR.md`. **Not packaged.** Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5` or `v1.0.0-rc.6`. Historical `1.0.0-dev.bulk.7` and `1.0.0-dev.bulk.8` remain immutable. Do **not** keep swapping R1 ZIP ↔ Bulk ZIP. |
...
| `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md` | Combined post-RC.6 Bulk Tools + R1 stream record (historical packaged identities `1.0.0-dev.bulk.7` and `1.0.0-dev.bulk.8`; current development identity `1.0.0-dev.bulk.9`, not packaged) |
...
| `docs/POST-RC6-BULK8-PHYSICAL-QA-REPAIR.md` | Bulk.9 repair of confirmed Bulk.8 physical-QA defects (not packaged) |

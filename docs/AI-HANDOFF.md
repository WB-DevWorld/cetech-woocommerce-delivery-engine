...
**Plugin version:** development tree **`1.0.0-dev.cartstate.1`** on `feat/post-rc9-cart-state` (schema `5`). Tagged/protected published baseline remains **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`). Do not retag RC.2–RC.9. Do not rebuild the RC.9 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**Post-RC.9 cart-state reconciliation:** **IN THIS TREE** — live cart lines refresh to current Delivery Engine configuration; stale admin fingerprints no longer force duplicate shipping groups; unavailable choices require in-cart reselection. Canonical record: `docs/POST-RC9-CART-STATE-RECONCILIATION.md`. Schema remains **`5`**. Not RC.10. Not Stage 15. FLAIROC not modified. RC.9 tag untouched.  
...
| Next stage | **STOP for owner physical QA of untagged `1.0.0-dev.cartstate.1`.** Tagged `1.0.0-rc.9` remains the protected published baseline. Development identity is `1.0.0-dev.cartstate.1` / schema `5`. Qualification: `docs/POST-RC9-CART-STATE-QA.md`. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.9` or earlier. Cursor must **not** install the owner-QA package. |
...
| Package | Current untagged owner-QA package **`1.0.0-dev.cartstate.1`** (`cetech-woocommerce-delivery-engine-1.0.0-dev.cartstate.1.zip`, `1401258` bytes, SHA-256 `5c72a87bdba7f77d2d2b66f7812f12fc448a2f84dc51748ab6c266d6a3175ecc`, source `39f61c1bc79e6248f1e64cdb945f62edf61b357b`, schema `5`). Cursor must not install it on FLAIROC or another owner site. Protected published `cetech-woocommerce-delivery-engine-1.0.0-rc.9.zip` (`1380751` bytes, SHA-256 `08862b8c048b92dd0ff42ded7eff29c3a5e42a42c984ac43e0a603cef50d96fd`, source `e6bc7fb`, tag `v1.0.0-rc.9`) remains immutable. Historical `1.0.0-dev.blocks.1.zip`–`blocks.4.zip` remain immutable QA artifacts. Final `cetech-woocommerce-delivery-engine-1.0.0-rc.8.zip` details in `docs/RC8-FINALIZATION.md`. Historical `cetech-woocommerce-delivery-engine-1.0.0-rc.7.zip` remains immutable. Historical `cetech-woocommerce-delivery-engine-1.0.0-rc.6.zip` (`1059918` bytes, SHA-256 `0d4adbef50462d798a4ff9bf802643bed92a35cdd332ceee13a985dbda2a689d`, source `7e52525`, tag `v1.0.0-rc.6`) remains immutable. Immutable `1.0.0-rc.6-qa.2.zip` / `1.0.0-rc.6-qa.1.zip` and protected historical `cetech-woocommerce-delivery-engine-1.0.0-rc.5.zip` remain unchanged. Historical `1.0.0-dev.bulk.7`–`1.0.0-dev.bulk.9` and `1.0.0-dev.fulfilment.1`–`fulfilment.4` ZIPs remain immutable. |

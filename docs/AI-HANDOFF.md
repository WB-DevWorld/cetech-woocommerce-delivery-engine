...
**Plugin version:** `1.0.0-rc.7` on `integration/post-rc6-bulk-r1` (promoted from owner-accepted `1.0.0-dev.bulk.9` Bulk Tools + R1 runtime). Tagged/protected published baseline is **`1.0.0-rc.7`** (schema `5`). Historical tagged **`1.0.0-rc.6`** (schema `4`) remains untouched. Do not retag RC.2–RC.7. Do not rebuild the RC.6 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
...
| Post-RC.6 RC.7 finalization | **THIS TREE** — version `1.0.0-rc.7`; schema `5`; artifact `docs/RC7-FINALIZATION.md`. Owner-accepted from `1.0.0-dev.bulk.9` on training.cetechbpa.com. FLAIROC not modified. RC.6 tag untouched. |
| Next stage | **STOP.** Tagged `1.0.0-rc.7` / schema `5` is the protected published baseline after Bulk.9 owner physical acceptance. Cursor must **not** install the ZIP. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, or `v1.0.0-rc.7`. Historical `1.0.0-dev.bulk.7`–`1.0.0-dev.bulk.9` remain immutable. Do **not** repair the known non-blocking Catalog preview Ready-to-apply presentation issue as part of this freeze. |

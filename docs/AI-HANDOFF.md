...
**Plugin version:** tagged/protected published baseline **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`) remains immutable. Narrow local stream **`1.0.0-dev.blocks-snapshot.1`** on `feat/post-rc9-blocks-line-snapshot` repairs native Blocks/Store API missing line `_cetech_de_delivery_snapshot`. Schema remains `5`. Not Stage 15. Do not retag RC.2–RC.9. Do not rebuild the RC.6, RC.7, RC.8, or RC.9 ZIP. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** (schema `5`), **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**Post-RC.9 Blocks line snapshot:** **IMPLEMENTED locally as `1.0.0-dev.blocks-snapshot.1`** — RC.9 native Blocks Delivery orders persist the package quote snapshot but not per-line `_cetech_de_delivery_snapshot`, so historical shipment planning fails `missing_order_item`. Artifact `docs/POST-RC9-BLOCKS-LINE-SNAPSHOT.md`. cartstate.1 / WCFM / WPML / FLAIROC / training untouched.  
...
**Git:** `feat/post-rc8-integrations` (promoted from frozen Blocks.4 to `v1.0.0-rc.9`). Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, and RC.8 tag `v1.0.0-rc.8` **untouched**.  
...
| Post-RC.9 Blocks line snapshot | **LOCAL STREAM `1.0.0-dev.blocks-snapshot.1`** — native Blocks/Store API now backfills the same immutable per-line snapshot as Classic after address sync. Schema **`5`**. RC.9 tag untouched. Not Stage 15. Artifact `docs/POST-RC9-BLOCKS-LINE-SNAPSHOT.md`. |
| Next stage | **STOP.** Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.9` or earlier. This stream is local QA only and is **not** deployed. |

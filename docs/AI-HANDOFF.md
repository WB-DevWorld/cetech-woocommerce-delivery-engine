...
**Post-RC.12 issue #35:** OPEN — GeoNames PCL* records can overwrite canonical country identity. Current candidate identity **`1.0.0-dev.geo-country.5`** on `fix/geonames-country-identity`, realigned onto protected `master` `d5ca30d1d92bb69b8a8ffbca2606d30906b8d4a1` (PR #37 PHP 8.3–8.5.x). Runtime/package-source SHA `ea2d412326e369bc7168b9de0dd01875673e71e6`. Frozen geo-country.4 runtime `ce1bcff053385a042993e50c3b216d8649d7b43d` / ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.4.zip` (`1,798,250` bytes, SHA-256 `2fc4996c0e403c41bce200dec5be680a05f56f9e666b5a3e4a13a400dba24354`) must not be overwritten. Frozen geo-country.3 runtime `bae75f79d0094c78706912c9a530f09ea21b9bed` / ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.3.zip` (`1,797,361` bytes, SHA-256 `a86a940d8ebac2c9e293dad8690ed8f121b5afa66cb3f1e0537f3f4152b26c66`) must not be overwritten. Frozen geo-country.2 runtime `23237eedece174b2f9c4334693b137310ce5c54a` / ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.2.zip` (`1,798,020` bytes, SHA-256 `6e7f76e2d218a01e2af401cc646471dc2ce27afc8a52c6ad15e671df0b88122c`) must not be overwritten. Frozen geo-country.1 ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.1.zip` (`1,794,741` bytes, SHA-256 `216e3a28d37e6af5f6cf97a69ef362dc946a94b1d26d8508c3d747d582198a6c`) must not be overwritten. PR `#36`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.geo-country.5.zip` (`1,812,883` bytes, SHA-256 `0d02bb14e2652dd635e858a3c8d4e65c233de81872ffa772225530a525e3d54d`). **Not RC.13.** Training physical repair QA COMPLETE 2026-09-21; plugin `1.0.0-dev.geo-country.5` left installed. PR `#36` unmerged. Issue `#35` OPEN. Artifact `docs/POST-RC12-GEONAMES-COUNTRY-IDENTITY.md`. RC.12 tag/ZIP remain immutable.  
...
| `docs/POST-RC12-GEONAMES-COUNTRY-IDENTITY.md` | Issue #35 GeoNames canonical country identity candidate (`1.0.0-dev.geo-country.5`; frozen geo-country.1–.4 evidence; not RC.13) |

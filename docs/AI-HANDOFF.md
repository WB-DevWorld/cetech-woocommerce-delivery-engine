...
**Plugin version:** RC.10 promotion candidate **`1.0.0-rc.10`** on `release/rc10` (schema `5`). Owner-qualified identity promotion of frozen `1.0.0-dev.qual.1` packaged source `c0000ab97aff8f2829ed9b173e0e6c7432b4eb9e`. Canonical record: `docs/RC10-FINALIZATION.md`. NOT Stage 15. WPML/WCML and WP Rocket certification remain separate. Historical `1.0.0-dev.qual.1` ZIP remains immutable. Historical tagged/protected **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`) remains untouched. Do not retag RC.2–RC.9. Do not rebuild the RC.9 or qual.1 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  

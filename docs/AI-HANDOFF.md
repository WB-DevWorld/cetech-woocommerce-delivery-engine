...
**Plugin version:** qualification tree **`1.0.0-dev.qual.1`** on `batch/pre-rc10-qualification` (schema `5`). NON-RELEASE, UNTAGGED, PRE-RC.10, QUALIFICATION-ONLY. Replays the recovered integrated.2 runtime delta onto protected `master` `0f9c2f06f9da0e15840fe27c8b28f7d146a5dd8d`, preserving the PHP 8.1 compatibility repair. Historical `1.0.0-dev.integrated.2` ZIP remains immutable and must not be rebuilt. Tagged/protected published baseline remains **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`). Do not retag RC.2–RC.9. Do not rebuild the RC.9 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
...
**Schema target:** tagged RC.9 = `5`. This development branch = `5`. Tagged RC.8 = `5`. Tagged RC.7 = `5`. Tagged RC.6 = `4`.  
**Git:** `batch/pre-rc10-qualification` is the neutral WS3 qualification assembly surface. Historical recovered branch `feat/post-rc9-customer-ux` remains immutable evidence and is **not** the canonical branch. Combined per-item + WCFM isolation + storefront cleanup remain the unreleased runtime delta. WPML is not merged; unique overlay remains `feat/post-rc9-wpml` @ `3b5b60d0d92b2edc00496d536774f8ac907cd6d2`. Historical `feat/post-rc9-integrated-candidate` preserved. Historical `feat/post-rc8-integrations` promoted to `v1.0.0-rc.9`. Historical `feat/post-rc7-fulfilment-correctness` promoted to `v1.0.0-rc.8`. Historical `integration/post-rc6-bulk-r1`, `feat/post-rc6-bulk-tools`, and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6`, RC.7 tag `v1.0.0-rc.7`, RC.8 tag `v1.0.0-rc.8`, and RC.9 tag `v1.0.0-rc.9` **untouched**.
...
| Pre-RC.10 qualification baseline | **IN ASSEMBLY** on `batch/pre-rc10-qualification` as untagged `1.0.0-dev.qual.1`. Combines protected master with the recovered 11-commit runtime delta. Not RC.10. Not merged to master. Artifact: `docs/qualification/PRE-RC10-QUALIFICATION-BASELINE.md`. |
| Next stage | **STOP.** Tagged `1.0.0-rc.9` remains the protected published baseline. Training in-place install was **not** completed from Cursor (no training SSH/WP-CLI/browser admin path). Neutral qualification identity is untagged `1.0.0-dev.qual.1` on `batch/pre-rc10-qualification`. WPML is not included. RC.10 has not been created. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.9` or earlier. Do **not** merge this batch branch to master. After a human in-place training install, confirm Active / `1.0.0-rc.9` / schema `5` / cart `12` / checkout `13` / layouts 1482·1496·1500 publish. Cursor must **not** install qualification packages. |
...
| `docs/qualification/PRE-RC10-QUALIFICATION-BASELINE.md` | WS3 INTEG-01 reconciled qualification baseline (`1.0.0-dev.qual.1`; not RC.10) |

...
**Post-RC.12 issue #38:** OPEN — PDP saved-region hydration can hide City/Town and show a broader-area delivery fee as final. Current candidate identity **`1.0.0-dev.pdp-precision.1`** on `fix/pdp-location-precision`, based on protected `master` `514ddfc1b4d10b2171d3d3bae020381198c59d2b`. Runtime/package-source SHA `dd078712bd97024d49ccd208a0b9d7e82d25f857`. PR `#40` open (do not merge). ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.pdp-precision.1.zip` (`1,823,157` bytes, SHA-256 `5773b5b2eb9d63bdc5e8b92bbbd156cb78ba4bc4deb74f34db105673542d3fda`). Schema `6`. **Not RC.13. Not deployed. Do not merge until owner/ChatGPT technical review.** Artifact `docs/POST-RC12-PDP-LOCATION-PRECISION.md`. RC.12 tag/ZIP remain immutable.  
...
| `docs/POST-RC12-PDP-LOCATION-PRECISION.md` | Issue #38 PDP location precision / exact delivery quote candidate (`1.0.0-dev.pdp-precision.1`; not RC.13; not deployed) |

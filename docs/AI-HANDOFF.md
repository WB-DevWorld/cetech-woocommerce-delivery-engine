...
| Post-RC.8 Settings honesty + Blocks | **IMPLEMENTED / NOT PACKAGED** — `1.0.0-dev.blocks.1`, schema `5`. Settings no longer expose ECR/Blocks/Classic/dead flags as ordinary toggles. Real Store API Cart/Checkout Blocks adapter declared `cart_checkout_blocks`. Classic unchanged. Artifact `docs/POST-RC8-BLOCKS-IMPLEMENTATION.md`. Not Stage 15. FLAIROC not modified. |
| Next stage | **STOP.** Development identity `1.0.0-dev.blocks.1` is implemented and tested, **not packaged**. Cursor must **not** install it. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5`, `v1.0.0-rc.6`, `v1.0.0-rc.7`, or `v1.0.0-rc.8`. Do not package until authorised. |
...
| `docs/POST-RC8-BLOCKS-IMPLEMENTATION.md` | Post-RC.8 Settings honesty + real Cart/Checkout Blocks adapter (`1.0.0-dev.blocks.1`, not packaged) |

...
**This working tree (`fix/post-rc6-admin-setup-defects`):** Post-RC.6 Repair R1 QA identity **`1.0.0-rc.6-r1-qa.1`**. Audit items 1–4 only. Schema remains `4`. **Not RC.7. Not a replacement for tagged `1.0.0-rc.6`.** ZIP `cetech-woocommerce-delivery-engine-1.0.0-rc.6-r1-qa.1.zip` (`1081009` bytes, SHA-256 `6eb0935c1046d4bd65ea017965970b7c0e4784a55d2db2758eab2be3841b5029`, source `41ca3e0`). Artifacts `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1.md`, `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1.md`. Owner physical QA on training.cetechbpa.com pending. In Store dual-choice, International ECR, Bulk Tools, FLAIROC, and tag `v1.0.0-rc.6` are untouched.  
...
| Post-RC.6 Repair R1 (this branch) | **QA.1 PREPARED** — branch `fix/post-rc6-admin-setup-defects`. Identity `1.0.0-rc.6-r1-qa.1`. Audit items 1–4 only. Schema still `4`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-rc.6-r1-qa.1.zip` (`1081009` bytes, SHA-256 `6eb0935c1046d4bd65ea017965970b7c0e4784a55d2db2758eab2be3841b5029`, source `41ca3e0`). Artifact `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1.md`. Owner physical QA on training.cetechbpa.com pending. No RC.7. |
...
| `docs/POST-RC6-ADMIN-SETUP-REPAIR-R1-QA1.md` | Training QA package `1.0.0-rc.6-r1-qa.1` — owner physical QA pending; FLAIROC not deployed |

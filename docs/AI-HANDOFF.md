...
**Post-RC.12 issue #32:** OPEN — Overview, Needs Attention page, and admin-menu badge share `NeedsAttentionCountQuery::unresolved_count_for_current_user()`. Candidate identity **`1.0.0-dev.attention-count.1`** on `fix/needs-attention-count-contract`, based on protected `master` `d66e5e366612468d7e5b4874e1a4290c5d2582cc` (Issue #31 CLOSED; PR #42 MERGED; post-merge CI `35756300042` SUCCESS). Runtime/package-source SHA `6e9e2ea71796170afb0508954a18d206cdc7017a`. PR `#43`. Runtime CI `35759882478` SUCCESS. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.attention-count.1.zip` (`1,848,319` bytes, SHA-256 `2027e5941916dff0302d7e2e545de5a2fd027f0c8f1615d97e3991dcfc5fdcb3`). Schema `6`. **Not RC.13. Not deployed. Do not merge until owner/ChatGPT technical review.** Artifact `docs/POST-RC12-NEEDS-ATTENTION-COUNT.md`. Training remains `1.0.0-dev.shipment-order-read.1`. Do not deploy attention-count.1. RC.12 tag/ZIP remain immutable.  
**Post-RC.12 issue #31:** CLOSED / COMPLETED — Shipment workspace Woo order-read recovery. MERGED via PR `#42` onto protected `master` `d66e5e366612468d7e5b4874e1a4290c5d2582cc`. Frozen identity **`1.0.0-dev.shipment-order-read.1`**. Runtime/package-source SHA `528e7c8b264f74848c85d77e172a25213db327dc`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.shipment-order-read.1.zip` (`1,845,224` bytes, SHA-256 `3dd4602ceedc26bcc3dab673271752c47c47e02d7e90e81fed832e9d498539f5`). Artifact `docs/POST-RC12-SHIPMENT-ORDER-READ.md`. Training currently `1.0.0-dev.shipment-order-read.1`.  

...
**Plugin version:** development identity **`1.0.0-dev.blocks.2`** on `feat/post-rc8-integrations` (starts from tagged `v1.0.0-rc.8`). Tagged/protected published baseline remains **`1.0.0-rc.8`** (schema `5`, tag `v1.0.0-rc.8`). Mixed Pickup fail-closed repair after blocks.1 physical QA. Do not retag RC.2–RC.8. Do not rebuild the RC.6, RC.7, or RC.8 ZIP. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  
**Post-RC.8 Settings honesty + Cart/Checkout Blocks:** **BLOCKS.2 REPAIR** — identity `1.0.0-dev.blocks.2`, schema **`5`**. Mixed Delivery + Pickup false fail-closed warning: `docs/POST-RC8-BLOCKS-2-PICKUP-RATE-REPAIR.md`. Blocks.1 QA ZIP remains a historical artifact. Classic unchanged. FLAIROC not modified. RC.8 tag untouched.  
...
| Post-RC.8 Settings honesty + Blocks | **BLOCKS.2 REPAIR** — `1.0.0-dev.blocks.2`, schema `5`. Mixed Delivery + Pickup false fail-closed warning repaired. Artifact `docs/POST-RC8-BLOCKS-2-PICKUP-RATE-REPAIR.md`. Not Stage 15. FLAIROC not modified. |
| Next stage | **STOP.** Repair identity `1.0.0-dev.blocks.2`. Owner recheck is **one** mixed In Store Blocks cart/checkout. Do **not** restart International/In Warehouse until that passes. Do **not** create RC.9. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.8`. |

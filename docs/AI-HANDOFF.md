...
**Plugin version:** `1.0.0-dev.bulk.8` on `integration/post-rc6-bulk-r1` (combined post-RC.6 Bulk Tools + R1 admin-repair development, plus Bulk background-execution portability). Tagged/protected published baseline remains **`1.0.0-rc.6`** (schema `4`). Do not retag RC.2–RC.6. Do not rebuild the RC.6 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.6 combined stream:** Bulk Tools schema **`5`** plus approved R1 admin/setup runtime repairs and QA.1 request-path repairs. Canonical record: `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md`. Background runner portability: `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY.md`. Historical Bulk branch `feat/post-rc6-bulk-tools` @ `720b513` and R1 branch `fix/post-rc6-admin-setup-defects` remain preserved. Previous untagged owner-QA packages **`1.0.0-dev.bulk.2`**–**`1.0.0-dev.bulk.7`** remain immutable (`1.0.0-dev.bulk.7.zip`, `1226695` bytes, SHA-256 `15ae60d059ef68cebae29329012a5b1e11373e7452c723701d39b5e86e5b50b1`, source `8fb99c9b43f16cbe96f478347af9601a6581fb80`, schema `5`). Current packaged identity **`1.0.0-dev.bulk.8`** (`1240853` bytes, SHA-256 `d8db4669e7a85ba178b9d8b7b6ab6a22e015562fe81cdc8e15262df55b263ea1`, source `ed57664e61087aca09eda58b904b9edf0e78aac2`, schema `5`) is for training-site physical QA of background-execution portability. **No physical PASS yet.** Cursor must not install it on training.cetechbpa.com, FLAIROC, or another owner site. R1 QA.1/QA.2 ZIPs remain immutable.  
...
| Post-RC.6 combined Bulk + R1 stream | **THIS TREE** — `integration/post-rc6-bulk-r1`, `1.0.0-dev.bulk.8`, schema `5`. Artifact `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md`. Bulk background portability: `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY.md`. Not RC.7. Not Stage 15. Previous packaged identity `1.0.0-dev.bulk.7` ZIP remains immutable. |
...
| Next stage | **STOP** after packaging `1.0.0-dev.bulk.8` for owner physical QA. Artifact `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY-QA.md`. **No physical PASS yet.** Cursor must **not** install the ZIP. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5` or `v1.0.0-rc.6`. Historical `1.0.0-dev.bulk.7` remains immutable. Do **not** keep swapping R1 ZIP ↔ Bulk ZIP. |
...
| `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md` | Combined post-RC.6 Bulk Tools + R1 stream record (historical packaged identity `1.0.0-dev.bulk.7`; current packaged identity `1.0.0-dev.bulk.8`) |
| `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY.md` | Bulk Tools background-execution portability audit + repair (no schema 6) |
| `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY-QA.md` | `1.0.0-dev.bulk.8` owner-QA package record (no physical PASS yet) |

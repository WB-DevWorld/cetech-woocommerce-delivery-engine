...
**Plugin version:** Tagged protected runtime baseline **`1.0.0-rc.10`** (`v1.0.0-rc.10` → `d1409258caf1a90675b689ab105471460de4c713`, schema `5`). Do not retag or overwrite the RC.10 ZIP. Post-RC.10 issue **#18** candidate identity on `fix/pdp-delivery-price-display` is **`1.0.0-dev.pdp-price.2`**. Not Stage 15. WPML/WCML and WP Rocket certification remain separate. Historical `1.0.0-dev.qual.1` ZIP remains immutable. Historical tagged/protected **`1.0.0-rc.9`** (schema `5`, tag `v1.0.0-rc.9`, source `e6bc7fba16d9d7b96682f2945c518a33a9a16cd5`) remains untouched. Do not retag RC.2–RC.10. Do not begin Stage 15. FLAIROC must not be modified. Historical tagged **`1.0.0-rc.8`** / **`1.0.0-rc.7`** (schema `5`) and **`1.0.0-rc.6`** (schema `4`) remain untouched.  

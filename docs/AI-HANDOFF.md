...
**Post-RC.12 issue #32:** CLOSED / COMPLETED — Overview, Needs Attention page, and admin-menu badge share `NeedsAttentionCountQuery::unresolved_count_for_current_user()`. MERGED via PR `#43` onto protected `master` `88c9ec09f3cfabf73b83780c0c37d397e9acdad6`. Runtime/package-source SHA `6e9e2ea71796170afb0508954a18d206cdc7017a`; final PR head `658316f775099b0dfc43205bb07c905681a4af10`. Runtime CI `35759882478`, final-head CI `35760847856`, and post-merge master CI `35766468276` all SUCCESS. Frozen ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.attention-count.1.zip` (`1,848,319` bytes, SHA-256 `2027e5941916dff0302d7e2e545de5a2fd027f0c8f1615d97e3991dcfc5fdcb3`). Training physical QA PASS; canonical aggregate / Overview / menu badge = `8 / 8 / 8`. Training currently runs `1.0.0-dev.attention-count.1`, schema `6`. This is not RC.13 and is not Pilot/FLAIROC/production promotion. Artifact `docs/POST-RC12-NEEDS-ATTENTION-COUNT.md`.  
**Post-RC.12 issue #31:** CLOSED / COMPLETED — Shipment workspace Woo order-read recovery. MERGED via PR `#42` onto protected `master` `d66e5e366612468d7e5b4874e1a4290c5d2582cc`. Frozen identity **`1.0.0-dev.shipment-order-read.1`**. Runtime/package-source SHA `528e7c8b264f74848c85d77e172a25213db327dc`. ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.shipment-order-read.1.zip` (`1,845,224` bytes, SHA-256 `3dd4602ceedc26bcc3dab673271752c47c47e02d7e90e81fed832e9d498539f5`). Artifact `docs/POST-RC12-SHIPMENT-ORDER-READ.md`. Training at Issue #31 closeout used `1.0.0-dev.shipment-order-read.1`; current training has since advanced to `1.0.0-dev.attention-count.1`.  
...
| Next stage | **STOP.** Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.11` or earlier. Do **not** merge PR #12. Independent ChatGPT merge-safety review of the RC.12 release PR is required before protected merge, final package, and tag. |
...
| `docs/POST-RC12-NEEDS-ATTENTION-COUNT.md` | Issue #32 unified Needs Attention count across Overview, page, and menu (`1.0.0-dev.attention-count.1`; not RC.13; not deployed; training remains shipment-order-read.1) |
| `docs/POST-RC12-SHIPMENT-ORDER-READ.md` | Issue #31 Shipment Workspace missing Woo order-read recovery (`1.0.0-dev.shipment-order-read.1`; MERGED PR #42; not RC.13; training currently shipment-order-read.1) |
| `docs/POST-RC12-CART-CHECKOUT-ADDRESS-UX.md` | Issue #39 compact cart/checkout delivery-address UX (`1.0.0-dev.address-ux.3`; frozen `.1`/`.2` ZIPs; MERGED PR #41; not RC.13; training currently `.3`) |

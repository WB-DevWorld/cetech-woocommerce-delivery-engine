...
**Plugin version:** `1.0.0-dev.bulk.9` on `integration/post-rc6-bulk-r1` (combined post-RC.6 Bulk Tools + R1 admin-repair development, plus Bulk.8 background-execution portability, plus Bulk.8 physical-QA repairs). Tagged/protected published baseline remains **`1.0.0-rc.6`** (schema `4`). Do not retag RC.2–RC.6. Do not rebuild the RC.6 ZIP. Do not begin Stage 15. FLAIROC must not be modified.  
**Post-RC.6 combined stream:** Bulk Tools schema **`5`** plus approved R1 admin/setup runtime repairs, QA.1 request-path repairs, Bulk.8 background portability, and Bulk.9 physical-QA repairs. Canonical record: `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md`. Background runner portability: `docs/POST-RC6-BULK-BACKGROUND-PORTABILITY.md`. Bulk.8 repair: `docs/POST-RC6-BULK8-PHYSICAL-QA-REPAIR.md`. Historical Bulk branch `feat/post-rc6-bulk-tools` @ `720b513` and R1 branch `fix/post-rc6-admin-setup-defects` remain preserved. Previous untagged owner-QA packages **`1.0.0-dev.bulk.2`**–**`1.0.0-dev.bulk.8`** remain immutable (`1.0.0-dev.bulk.8.zip`, `1240853` bytes, SHA-256 `d8db4669e7a85ba178b9d8b7b6ab6a22e015562fe81cdc8e15262df55b263ea1`, source `ed57664e61087aca09eda58b904b9edf0e78aac2`, schema `5`). Current packaged identity **`1.0.0-dev.bulk.9`** (`1256253` bytes, SHA-256 `af331732c1529427c85adc8cfaeb7dbf26ef996e2952b3918f15c25da4f100b2`, source `85194cb86ab3d906e6642a3f15b1027767a12da8`, schema `5`) is for a six-check training-site acceptance run of the Bulk.8 physical-QA repairs. **No physical PASS yet.** Cursor must not install it on training.cetechbpa.com, FLAIROC, or another owner site. R1 QA.1/QA.2 ZIPs remain immutable.  
**Schema target:** tagged RC.6 = `4`. This development branch = `5`.  
**Git:** `integration/post-rc6-bulk-r1`. Historical `feat/post-rc6-bulk-tools` and `fix/post-rc6-admin-setup-defects` not rewritten. Unrelated RC.6 security-audit leftovers preserved on `wip/rc6-adversarial-security-audit` @ `a88f28048afcc84456e6933351c71b01a9838c5a`. RC.6 tag `v1.0.0-rc.6` **untouched**.  
...
| Post-RC.6 combined Bulk + R1 stream | **THIS TREE** — `integration/post-rc6-bulk-r1`, `1.0.0-dev.bulk.9`, schema `5`. Artifact `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md`. Bulk.8 physical-QA repairs: `docs/POST-RC6-BULK8-PHYSICAL-QA-REPAIR.md`. Packaged identity: `docs/POST-RC6-BULK9-OWNER-QA.md`. Not RC.7. Not Stage 15. Previous packaged identities `1.0.0-dev.bulk.7` and `1.0.0-dev.bulk.8` remain immutable. **No physical PASS yet.** |
...
| Next stage | **STOP** after packaging `1.0.0-dev.bulk.9` for the six-check owner physical QA. Artifact `docs/POST-RC6-BULK9-OWNER-QA.md`. **No physical PASS yet.** Cursor must **not** install the ZIP. Do **not** begin Stage 15. Do **not** modify FLAIROC. Do **not** retag `v1.0.0-rc.5` or `v1.0.0-rc.6`. Historical `1.0.0-dev.bulk.7` and `1.0.0-dev.bulk.8` remain immutable. Do **not** keep swapping R1 ZIP ↔ Bulk ZIP. |
...
| `docs/POST-RC6-CONSOLIDATED-DEVELOPMENT-STREAM.md` | Combined post-RC.6 Bulk Tools + R1 stream record (historical packaged identities `1.0.0-dev.bulk.7` and `1.0.0-dev.bulk.8`; current packaged identity `1.0.0-dev.bulk.9`) |
...
| `docs/POST-RC6-BULK9-OWNER-QA.md` | `1.0.0-dev.bulk.9` owner-QA package record (six-check acceptance; no physical PASS yet) |

...
**Post-RC.12 issue #39:** OPEN — Cart/checkout delivery-address actions and per-item editor need clearer hierarchy and compact UX. Current candidate identity **`1.0.0-dev.address-ux.2`** on `fix/cart-checkout-address-ux`, based on protected `master` `ed3753d73e262d8c7467fa936e3e36060960e58c` (Issue #38 CLOSED; PR #40 MERGED). Previous `.1` runtime SHA `797bdce784ecbe44996cc0e46dbe8d2920a52b08`. Runtime/package-source SHA `b2acea7ba75f31cd6a7851fcbf594bf798bfd79d`. PR `#41` open (do not merge). ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.address-ux.2.zip` (`1,837,972` bytes, SHA-256 `e914efc0ee73132efffab6899cf9627ac3d01ecf6b579f190b3050cdd43e117f`). Frozen predecessor ZIP `cetech-woocommerce-delivery-engine-1.0.0-dev.address-ux.1.zip` (`1,832,223` bytes, SHA-256 `2a28798140fafaa7d7b4e20bc4e3878fd1949f7014af854b002960a3ae1120fe`) must not be overwritten. Schema `6`. **Not RC.13. Not deployed. Do not merge until owner/ChatGPT final deployment review.** Artifact `docs/POST-RC12-CART-CHECKOUT-ADDRESS-UX.md`. Training remains on `1.0.0-dev.pdp-precision.2`. RC.12 tag/ZIP remain immutable.  
...
| `docs/POST-RC12-CART-CHECKOUT-ADDRESS-UX.md` | Issue #39 compact cart/checkout delivery-address UX candidate (`1.0.0-dev.address-ux.2`; frozen `.1` ZIP; not RC.13; not deployed) |

...
**PHP minimum:** 8.1+
**Current known implementation baseline:** repair-branch QA tree `1.0.0-rc.6-r1-qa.2`, schema target `4`; protected published tags `1.0.0-rc.6` and historical `1.0.0-rc.5`  

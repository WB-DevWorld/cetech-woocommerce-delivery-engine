...
**PHP minimum:** 8.1+
**Current known implementation baseline:** tagged `1.0.0-rc.9`, schema target `5`; protected published tags `1.0.0-rc.9` and historical `1.0.0-rc.8` / `1.0.0-rc.7` / `1.0.0-rc.6` / `1.0.0-rc.5`  

...
**Current development tree:** `1.0.0-dev.peritem.1` on `feat/post-rc9-per-item-context` (schema `5`). Tagged RC.9 remains schema `5` and must not be retagged or rebuilt.  

...
Current technical-correction candidate identity: `1.0.0-dev.geo.16` (`7aeb4c573d04d12d8101c0e05bc8858ff332d63f`). Package `cetech-woocommerce-delivery-engine-1.0.0-dev.geo.16.zip` SHA-256 `500b09878ba08b879e5bdfdb0ea6e58726a71fe90a6994a83bb96b1e314a3925`. Schema `6`. Location Packs install, continue/retry and reconciliation forms now use `AdminFormHelper::nonce_field(ACTION)` plus hidden `cetech_de_action`. `AdminActionHandler` security contract is unchanged. Matching precedence is unchanged. Do not physically QA until independent review accepts the geo.15→geo.16 differential as confined to this UI contract correction.

...
RC.12: tagged `v1.0.0-rc.12` / `78594ad8962868683726373f58f4a8b1b48e4d0e` / schema `6`. Training site `https://training.cetechbpa.com` runs RC.12 / schema 6; training-site qualification **PASS** (not Stable-1.0 certification). CETECH Pilot **NOT STARTED**. FLAIROC **NOT DEPLOYED**. Production **NOT DEPLOYED**.

...
Filled after packaging from a clean committed tree.
...
3. Visit known Delivery Engine URLs directly (`admin.php?page=cetech-delivery-engine` and Site-wide Defaults, Delivery Options, Delivery Areas, Delivery Charges, Pickup Locations, Product Exceptions, Bulk Tools, Shipments, Needs Attention, Suppliers/Origins, Logistics Profiles, Diagnostics). Each must be denied. Stale A/old delivery details must not be shown as global administration.

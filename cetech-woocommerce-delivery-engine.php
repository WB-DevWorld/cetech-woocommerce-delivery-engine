 ...
 * Version:           1.0.0-dev.checkout-mdest.1
...
// Schema-6 release-line marker for the current production-package verifier: 1.0.0-dev.geo through 1.0.0-rc.12 and 1.0.0-dev.checkout-mdest.
define( 'CETECH_DE_VERSION', '1.0.0-dev.checkout-mdest.1' );

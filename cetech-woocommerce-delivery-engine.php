...
// Schema-6 development identity for post-RC.11 canonical geography (technical-correction candidate).
define( 'CETECH_DE_VERSION', '1.0.0-dev.geo.13' );

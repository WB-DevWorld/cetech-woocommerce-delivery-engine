 ...
 * Version:           1.0.0-dev.geo-country.2
...
// Schema-6 release-line marker for the current production-package verifier: 1.0.0-dev.geo through 1.0.0-rc.12, 1.0.0-dev.checkout-mdest, 1.0.0-dev.geo-live, and 1.0.0-dev.geo-country.
define( 'CETECH_DE_VERSION', '1.0.0-dev.geo-country.2' );

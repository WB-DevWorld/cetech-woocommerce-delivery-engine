 ...
 * Version:           1.0.0-dev.shipment-order-read.1
...
// Schema-6 release-line marker for the current production-package verifier: 1.0.0-dev.geo through 1.0.0-rc.12, 1.0.0-dev.checkout-mdest, 1.0.0-dev.geo-live, 1.0.0-dev.geo-country, 1.0.0-dev.pdp-precision, 1.0.0-dev.address-ux, and 1.0.0-dev.shipment-order-read.
define( 'CETECH_DE_VERSION', '1.0.0-dev.shipment-order-read.1' );

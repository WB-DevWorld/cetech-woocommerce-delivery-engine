...
/**
 * Minimal in-memory delivery offer repository for constraint/parity tests.
 */
final class InMemoryDeliveryOfferRepository implements DeliveryOfferRepositoryInterface {

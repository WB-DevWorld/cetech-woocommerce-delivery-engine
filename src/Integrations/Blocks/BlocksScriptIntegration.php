			...
			wp_localize_script(
				...
				[
					...
					'i18n'      => [
						...
						'changeDelivery' => __( 'Change delivery', 'cetech-woocommerce-delivery-engine' ),
						'changePickup' => __( 'Change pickup', 'cetech-woocommerce-delivery-engine' ),
						...
						'useForAll' => __( 'Use this address for all eligible delivery items', 'cetech-woocommerce-delivery-engine' ),
						...
						'applyCheckoutAddress' => __( 'Use checkout shipping address for incomplete delivery items', 'cetech-woocommerce-delivery-engine' ),
